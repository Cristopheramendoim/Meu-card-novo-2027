...
import { Clapperboard, Palette, Sparkles, Paintbrush } from 'lucide-react';
...
export default function App() {
  ...
  // Ensure browser tab favicon is set with the camera icon
  useEffect(() => {
    const CAMERA_FAVICON = "data:image/svg+xml;base64,";

    const setFavicon = (url: string, type = 'image/svg+xml') => {
      ...
      if (links.length === 0) {
        ...
        links.forEach((l) => {
          const linkEl = l as HTMLLinkElement;
          linkEl.href = url;
          linkEl.type = type;
        });
      }
    ...
    // Set camera SVG icon immediately
    setFavicon(CAMERA_FAVICON, 'image/svg+xml');

    // Also convert to high-res PNG for browsers needing PNG
    const img = new Image();
    img.src = CAMERA_FAVICON;
    img.onload = () => {
