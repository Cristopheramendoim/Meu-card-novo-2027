...
// Packed low → high colour ramp for the "Waves" preset (only the first 4 are used).
...
export default function ShaderBackground() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Fullscreen triangle covering the viewport without a separate quad/index buffer.
      ...
      gl.uniform3fv(uColors, new Float32Array(PALETTE.flat()));
      ...
      const render = () => {
        ...
        // speed 35 -> 0.76, zoom 59 -> scale 1.68, intensity 72 -> 0.72, contrast 53 -> 1.08, grain 24 -> 0.08
        gl.uniform4f(uScene, canvas.width, canvas.height, t * 0.76, 4.0);
        gl.uniform4f(uShape, 1.68, 0.72, 0.5, 0.0);
        gl.uniform4f(uSurface, 2.4, 1.08, 0.0, 1.0);
        gl.uniform4f(uFinish, 0.0, 0.0, 0.0, 0.08);
        gl.uniform4f(uTransform, 8617.0, 0.0, 0.0, 0.0);
